...
## 1. Vì sao cần quản lý dịch hại tổng hợp cho cam
...
## 2. Năm trụ cột của quản lý dịch hại tổng hợp trên cam

### 2.1. Trụ cột 1 — Cây khoẻ
...
### 2.2. Trụ cột 2 — Bảo vệ thiên địch
...
### 2.3. Trụ cột 3 — Quan sát thường xuyên và đếm ngưỡng
...
| Đối tượng | Ngưỡng phun |
|---|---|
| Sâu vẽ bùa | Trên 30 phần trăm lá non có dấu vẽ |
| Rệp sáp | Trên 5 con mỗi cành |
| Rầy chổng cánh | Bất kỳ con nào trên đọt non (vì truyền bệnh greening) |
| Ruồi vàng đục trái | Trên 5 phần trăm quả bị đục |
| Sâu đục thân | Phát hiện đùn mạt thì xử lý ngay |

Dưới ngưỡng — không phun. Trên ngưỡng — phun đúng đối tượng, không phun lan man.

### 2.4. Trụ cột 4 — Biện pháp cơ học và sinh học
...
## 3. Lịch áp dụng theo năm cho cam
...
## 4. Cách áp dụng cho vườn đang phun định kỳ
...
- [Phòng trừ sâu vẽ bùa cho cam](/huong-dan/phong-tru-sau-ve-bua-1370)
