...
def sitemap(db: Session = Depends(get_db)) -> Response:
    urls: list[tuple[str, str, str, str | None]] = [
        ...
        (f"{SITE_BASE}/khuyen-nghi-bon-phan/thoi-diem-ban", "0.7", "weekly", None),
        (f"{SITE_BASE}/khuyen-nghi-bon-phan/chenh-lech-vung", "0.7", "weekly", None),
        (f"{SITE_BASE}/khuyen-nghi-bon-phan/so-sanh-cay-trong", "0.7", "weekly", None),
